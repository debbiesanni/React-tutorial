...
export default function CourseSubscribers({ data, errorMessage }) {
    ...
    const { centreId, courseId } = router.query;
                    ...
                    <div style={{ width: 130 }}>
                        {status === 'PENDING' && (
                            ...
                            >
                                <Delete
                                    name="User"
                                    url={`/centre/${centreId}/course/${courseId}/subscriber/${subscriber.id}`}
                                    reject={true}
    ...
    return (
        <div className={` ${globalStyle.fullWidthSlider}`}>
            ...
            >
                ...
                <Link
                    text="Course"
                    link={`centre/${centreId}/course/${centreId}`}
            ...
            >
                <h2 className={globalStyle.bottom1rem}>Course Subscribers</h2>
                <div>
                    <Dropdown
                        trigger={
                        ...
                        content={
                            <div style={{ width: 100 }}>
                                <Link
                                    text="VERIFIED"
                                    link={`/centre/${centreId}/course/${courseId}/subscribers?status=VERIFIED&pageId=1`}
                                    className={globalStyle.greyColor}
                                />
                                <Link
                                    text="PENDING"
                                    link={`/centre/${centreId}/course/${courseId}/subscribers?status=PENDING&pageId=1`}
                                    className={globalStyle.greyColor}
                                />
                                <Link
                                    text="BLOCKED"
                                    link={`/centre/${centreId}/course/${courseId}/subscribers?status=BLOCKED&pageId=1`}
                                    className={globalStyle.greyColor}
                                />
                            </div>
                        }
