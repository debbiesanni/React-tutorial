...
export default function GenerateResult({ centre }) {
    ...
    const columns: ColumnProps[] = [
        ...
        { header: 'Generate code', accessor: 'assessment' },
    ];

    const result = data.map((list, index) => ({
        sn: ++index,
        assessment: list.btn ? (
            <span className={styles.btnDownLoad}>Generate</span>
        ) : (
            <span className={styles.btnGenerate}>Code Generated</span>
        ),
        ...list,
    }));
