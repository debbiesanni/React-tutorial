    ...
    return (
        <Wrapper centre={centre} user={user}>
            <div className={`${styles.container}`}>
                ...
                >
                    <div className={styles.title}>Grades</div>
                </div>
                {data.map((list, index) => (
                            ...
                            <>
                                ...
                                {assessement.map((list, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <span style={{marginRight: 20}}>Maximum Score: 60</span>
                                            <span style={{marginRight: 20}}>Minimum Score: 70</span>
                                            <span>Remark: Very Good</span>
