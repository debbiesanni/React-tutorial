...
export default function Search({ phrase, centreId, className=null }) {
    ...
    return (
        <div style={{padding: '1rem'}} className={className}>
            ...
            {loading ? (
                ...
                <div
                    className={`${categories !== 'publication' ? globalStyle.displayFlex : style.centrePublicationCard} ${globalStyle.justifySpaceBtw} ${globalStyle.flexWrp}`}
                >
                    {displayResult}
                </div>
            ) : (
