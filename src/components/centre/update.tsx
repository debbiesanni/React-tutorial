...
export default function CentreContact({
    ...
    async function submit() {
        ...
        try {
            ...
            exclude.forEach((key) => {
                if(createForm.values[key] === false || createForm.values[key] === '' || createForm.values[key] === null) {
    ...
    return (
        <>
            {editText ? 
                <div title="Edit" onClick={() => openDialog()}>
                    <span
            ...
            : <div  onClick={() => openDialog()}><EditIcon color={color ? color : "primary"} /></div>
            }
            <Dialog
                content={addContect}
                open={isOpen}
